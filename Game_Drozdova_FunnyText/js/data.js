const GameData = {
  ...
  level1: {
    questions: [
      ...
      { text: "Кто живёт в воде? (Двойной клик!)", type: "swim" },
      { text: "Найди всех домашних животных (Двойной клик!)", type: "domestic" },
      { text: "Найди все объекты, созданные человеком (Двойной клик!)", type: "object" },
      { text: "Найди всех насекомых (Двойной клик!)", type: "insect" },
    ],
    items: [
